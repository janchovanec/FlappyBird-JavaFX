...
public class Pipe implements IPipe{
    ...
    public Pipe(double pipeHeight1, double pipeHeight2, double xPos, double scrollSpeed, PipeListener pipeListener) {
        ...
        this.pipeCenter1 = new Image(getClass().getResourceAsStream("centerPipe.png"), PIPEWIDTH, pipeHeight1, false, true);
        this.pipeCenter2 = new Image(getClass().getResourceAsStream("centerPipe.png"), PIPEWIDTH, pipeHeight2, false, true);
        this.pipeCap = new Image(getClass().getResourceAsStream("capPipe.png"), PIPEWIDTH, 0, true, true);
        this.hitbox1 = new Rectangle(position1.getX() - (pipeCenter2.getWidth()*0.1), position1.getY()+pipeCap.getHeight()/2, 
                                     pipeCenter1.getWidth() - (pipeCenter2.getWidth()*0.1), pipeCenter1.getHeight()-pipeCap.getHeight()/2.5);
        this.hitbox2 = new Rectangle(position2.getX() + (pipeCenter2.getWidth()*0.1), position2.getY(), 
                                     pipeCenter2.getWidth() - (pipeCenter2.getWidth()*0.1), pipeCenter2.getHeight()-pipeCap.getHeight()/2.5);
    }
